...
{
    class LinkFacingNorthState2 : ILinkState
    {
        private Player player;
        private int frames_left;

        public LinkFacingNorthState2(Player player)
        {
            this.player = player;
        ...
        void ILinkState.Draw(SpriteBatch spriteBatch, float xPos, float yPos)
        {
            ...
            Rectangle source = LinkTextureStorage.LINK_STEP_NORTH;
        ...
        {
            if (buttons.Contains(ButtonKind.UP))
            {
