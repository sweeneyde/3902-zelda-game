...
{
    class ThunderDomeVictoryState : IGameState
    {
        private Game1 game;
        ...
        public ThunderDomeVictoryState(Game1 game, SpriteFont font)
        {
            this.game = game;
            this.font = font;
            cursorpos = 0;
        ...
        {
            sb.DrawString(font, "You conquered the Thunderdome!", new Vector2(20, 30), Color.Red);
            sb.DrawString(font, "Go Again", new Vector2(50, 80), Color.Red);
